        ...
        case "title":
          if (action.value === "") {
            ...
            state.stocks.forEach((stock) => {
              if (
                stock.title.includes(action.value) ||
                stock.title.toLowerCase().includes(action.value)
              )
                filteredStocksCopy = [...filteredStocksCopy, stock];
            });
          }
          break;
        ...
        case "title":
          if (action.value === "") {
            ...
            state.bonds.forEach((bond) => {
              if (
                bond.title.includes(action.value) ||
                bond.title.toLowerCase().includes(action.value)
              )
                filteredBondsCopy = [...filteredBondsCopy, bond];
            });
          }
          break;
