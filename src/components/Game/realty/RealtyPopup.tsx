...
import { activeRealtyType, ChanceType, myRealtyType } from "../../../redux/game/realty/typings"
...
export const RealtyPopup: FC = React.memo(() => {
  ...
  const onCloseClick = () => {
    dispatch( setPopupsShownThunk(isRealtyToBuy ? popupsEnum.REALTY_BUY : popupsEnum.REALTY_SELL, false) )
